...
if __name__ == "__main__":
    while True:
        ...
        if detected_color == "Red":
            print("Going to Red destination")
            # Add your code to go to the red destination here
        elif detected_color == "Blue":
            print("Going to Blue destination")
            # Add your code to go to the blue destination here
        else:
